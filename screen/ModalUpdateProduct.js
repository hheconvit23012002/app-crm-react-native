...
const ModalUpdateProduct = ({ visible, onClose, loadBook, book }) => {
    ...
    const submitProduct = async () => {
        try {
            ...
            let data = await product.post(`/book/update/${formData.id}`,formData)
            ...
            console.log(error)
            onClose();
            showToast('error','update product error')
        }
        setFormData({
            title: '',
            price: '',
                    ...
                    <TouchableWithoutFeedback>
                        <View style={styles.modalContent}>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
                                <Text style={{ fontSize: 20, fontWeight: '700' }}>Update Product</Text>
                            ...
                            <ScrollView style={{ height : 300}}>
                                ...
                                <SelectList
                                    ...
                                    defaultOption={{key : formData.category_id, value : formData.category_name }}   //default selected option
                                />
